...
/****** Object:  StoredProcedure [dbo].[spcAbcClientes]    Script Date: 30/11/2016 16:42:19 ******/
DROP PROCEDURE [dbo].[spcAbcClientes]
GO
...
CREATE PROCEDURE [dbo].[spcAbcClientes]
...
CREATE TABLE #tmpRetorno(cd_cadastro CHAR(30), fantasia CHAR(200), vl_faturamento MONEY, qtde DECIMAL(10,4),
                         percentualvL DECIMAL(10,4), percentualqt DECIMAL(10,4))    

INSERT INTO #tmpRetorno
 SELECT OINV.CardCode, OINV.CardName, SUM(INV1.LineTotal), SUM(INV1.Quantity), 0, 0  
  FROM OINV, INV1  
